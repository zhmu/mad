...
#define DLGMAN_CONTROL_MAXCAPTIONLEN    512     /* maximum length of a caption */
...
#define DLGMAN_CONTROL_SPRITE_BORDERCOL 0       /* sprite: focus border color */

#define DLGMAN_LIST_SELCOLOR            0       /* selected color */
#define DLGMAN_LIST_BACKSELCOLOR        15      /* background color of selection */

#define DLGMAN_DIALOG_BACKCOLOR         7       /* dialog background color */
#define DLGMAN_DIALOG_BORDERCOL         15      /* upper-left border color */
#define DLGMAN_DIALOG_BORDERCOL2        8       /* lower-right border color */
#define DLGMAN_DIALOG_TITLEBARCOLOR     1       /* color of the title bar */
#define DLGMAN_DIALOG_TITLECOLOR        12      /* title color */
/* Rink [20070120]: The above constant was 14, but this is practically
 * unreadable now; so I chose to fix it to 12 */
...
#define DLGMAN_BUTTON_BACKCOLOR         7       /* button background color */
#define DLGMAN_BUTTON_BORDERCOL         15      /* upper-left border color */
#define DLGMAN_BUTTON_BORDERCOL2        8       /* lower-right border color */

#define DLGMAN_FOCUSCOL                 0       /* color of focus indicating box */
...
#define DLGMAN_TEXTINPUT_BORDERCOL      0       /* text input box border color */
#define DLGMAN_TEXTINPUT_BACKCOL        7       /* text input box background color */
#define DLGMAN_TEXTINPUT_TEXTCOL        0       /* text input box text color */
...
public:
    ...
    void   setcolor(_UCHAR);          /* set color of the control */
...
private:
    ...
    _UINT  spriteno;                  /* sprite: sprite number */
...
private:
    ...
    char   title[DLGMAN_CONTROL_MAXCAPTIONLEN];
};
