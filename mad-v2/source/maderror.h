...
#define MAD_DOS_ERROR_MSG "We're sorry, you have encountered a MAD error. Please report\n" \
                          "the following information to rink@springer.cx so we can\n" \
                          "look at the problem. Thank you.\n\n"

/* Script manager errors */
#define MAD_ERROR_100 "Error 100: unknown object opcode $%x at offset $%x"
#define MAD_ERROR_101 "Error 101: script procedure '%s' hasn't got valid offsets"
#define MAD_ERROR_102 "Error 102: length of string at offset $%x is $%x bytes, and maximum is set to $%x"
#define MAD_ERROR_103 "Error 103: variable 1 has type $%x, which is unknown"
#define MAD_ERROR_104 "Error 104: variable 2 has type $%x, which is unknown"
#define MAD_ERROR_105 "Error 105: condition $%x is unknown"
#define MAD_ERROR_106 "Error 106: variable has type $%x, which is unknown (offset $%x)"
#define MAD_ERROR_107 "Error 107: handleobjectopcode() called with previous opcode $%x"
#define MAD_ERROR_108 "Error 108: tried to access object $%x, but $%x is the maximum object possible"
#define MAD_ERROR_109 "Error 109: unable to set halt sequence '%s' at $%x"
#define MAD_ERROR_110 "Error 110: can only dispose scripts from main script"
#define MAD_ERROR_111 "Error 111: couldn't find animation sequence '%s' for object $%x"
#define MAD_ERROR_112 "Error 112: cannot set priority level to $%x when there are $%x priorities possible"
#define MAD_ERROR_113 "Error 113: unknown opcode $%x at offset $%x"
#define MAD_ERROR_114 "Error 114: procedure '%s' never declared"
#define MAD_ERROR_115 "Error 115: activate with invalid object type $%x"
#define MAD_ERROR_116 "Error 116: file '%s' is not a mad script file"
#define MAD_ERROR_117 "Error 117: file '%s' is of a wrong version"
#define MAD_ERROR_118 "Error 118: unknown expression type value $%x"
#define MAD_ERROR_119 "Error 119: cannot leave root script"
...
#define MAD_ERROR_300 "Error 300: animation object '%s' doesn't have a valid source number"
#define MAD_ERROR_301 "Error 301: animation object '%s' doesn't have a valid animation sequence number"
#define MAD_ERROR_302 "Error 302: animation object '%s' doesn't have a valid animation frame number"
#define MAD_ERROR_303 "Error 303: animation object '%s' doesn't have a valid animation sprite number"
