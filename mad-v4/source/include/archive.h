...
#define ARCHIVE_VERSION                 201                     /* means 2.0 */
#define ARCHIVE_COMPRESSLEVEL           6                       /* compression level */
...
#define ARCHIVE_COMPRESSERR         0xb         /* compression error */
...
struct ARCHIVEFILE {
	...
	_ULONG	size;			/* size */
    _ULONG  real_size;      /* uncompressed size */
	_UCHAR	reserved[6];		/* unused */
};
