...
#define FONTMAN_ALIGN_LEFT   0
#define FONTMAN_ALIGN_RIGHT  1
#define FONTMAN_ALIGN_CENTER 2
...
public:
       ...
       _UINT  getsentencewidth(_UINT,char*);

       void   textout(_UINT,_ULONG,char *text,_SINT,_SINT,_UCHAR,char*);

private:
       _UCHAR charout(char,_SINT,_SINT,char*);
       _UCHAR charexists(_UINT,_UCHAR);

       void   charout(_UINT,_UCHAR,_ULONG,_SINT,_SINT,char*);
