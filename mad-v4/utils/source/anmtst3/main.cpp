/*
 *                  MAD Animation Test Utility Version 3.0
 *                       (c) 1999, 2000 the MAD Crew
 *
 */
#define  DOS

#define  BANNER                 "MAD Animation Test Utility Version 3.0\n(c) 1999, 2000 The MAD Crew\n"
#define  MAX_FILENAME_LEN       64

#include <stdio.h>
#include <conio.h>
#include "../../../source/anm.h"
#include "../../../source/controls.h"
#include "../../../source/ctrldrv.h"
#include "../../../source/gfx.h"
#include "../../../source/gfx_drv.h"
#include "../../../source/types.h"

/* it's bad karma to include c-files, but still... */
#include "../../../source/ctrldrv.cpp"
#include "../../../source/gfx_vesa.cpp"
...
load_anm(char* fname) {
    ...
    for(count=0;count<hdr->nofanims;count++) {
        ...
        memcpy(&anim[count].frame,(char *)(anmdata+pos),anim[count].anm.noframes);
...
main(int argc,char* argv[]) {
    ...
    /* zap everything */
    gfx_drv=NULL;vscreen=NULL;ctrl_drv=NULL;anmdata=NULL;backscreen=NULL;
